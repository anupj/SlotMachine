...
//        setupSecondContainer(self.secondContainer)
        setupThirdContainer(self.thirdContrainer)
    ...
    func setupContainerViews() {
        ...
        self.thirdContrainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: firstContainer.frame.height + secondContainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * kSixth))
        self.thirdContrainer.backgroundColor = UIColor.lightGrayColor()
        self.view.addSubview(self.thirdContrainer)
        
        // setup fourth container
        self.fourthContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: firstContainer.frame.height + secondContainer.frame.height + thirdContrainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * kSixth))
    ...
    func setupFirstContainer(containerView: UIView) {
        ...
        self.titleLabel.font = UIFont(name: "Baskerville-BoldItalic", size: 40)
